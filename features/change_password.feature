Feature: A user should be able to change his password
  ...
  #   And fills in his current password: "thispassword!", new password: "newpasswordHere!", and new password confirmation "newpasswordHere!"
  #   And submits the change password form
  #   Then the user should be redirected to the login page
  #   When the user enters his correct credentials in the login page, email: "thisemail@moralitos.com" and password "newpasswordHere!"
  #   And submits the login page
  #   Then the user should be shown the root page
